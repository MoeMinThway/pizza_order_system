 ...
 <div class="main-content">
    <div class="section__content section__content--p30">
     ...
     <select name="orderStatus" id="inputGroupSelect02" class=" custom-select">
                                        ...
                                        <option @if(request('orderStatus')  == '1') selected @endif  value="1">Accept</option>
                                        <option @if(request('orderStatus') == '2') selected @endif  value="2">Reject</option>
                    </select>
  <div class="input-group-append">
       <button type="submit" class="btn sm bg-dark text-white "><i class=" fa-solid  fa-magnifying-glass"></i> </button>
