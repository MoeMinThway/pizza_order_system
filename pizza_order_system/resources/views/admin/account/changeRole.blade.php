            ...
            <div class="col-lg-10 offset-1">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin#change',$account->id)}}" enctype="multipart/form-data" method="POST">
@csrf
                            <div class="row">
                        ...
                        <div class="mt-3">
                                <input disabled type="file" name="image" class="form-control col-12
                        ...
                        <div class="mt-5">
                                ...
                                <a href="{{route('admin#list')}}"><button class="btn bg-warning text-white my-3"><i class="fa-solid fa-circle-chevron-left me-2"></i> Cannel</button></a>
                            ...
                            <div class="form-group col-10">
                                ...
                                <input disabled id="phone " name="phone" type="number"
                        ...
                        @enderror
                            ...
                            <div class="form-group col-10 me-2">
                               ...
                               <textarea name="address" class="form-control  @error('address')   is-invalid   @enderror" disabled id="address" placeholder="Enter Admin Address" cols="10" rows="5"> {{old('address',$account->address)}} </textarea>
                               @error('address')
                               <div class="invalid-feedback text-danger">{{$message}}</div>
                           @enderror
                            </div>
